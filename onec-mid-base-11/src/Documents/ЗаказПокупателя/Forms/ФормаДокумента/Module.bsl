...
&НаКлиенте
Процедура ДЗ_ПересчитатьТаблицуВместо(Команда)
      ЦиклПересчетаЦен()
КонецПроцедуры
...
// ++ Блохин ВСТАВКА задача 11-3-2 пересчет скидки
	...
	Если ИтоговаяСкидка > 100 Тогда
		ИтоговаяСкидка = 100;   
  		Сообщить(СтрШаблон("Внимание! Превышение скидки более 100 процентов у позиции: %1, скидка установлена в 100 процентов", ТекущиеДанные.Номенклатура));
